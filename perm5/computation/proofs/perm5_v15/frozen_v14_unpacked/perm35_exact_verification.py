"""Independent exact verification for the n=3 and n=5 permanent Chow study.
...
def main() -> None:
    ...
    parser.add_argument("--n", type=int, choices=(3, 5), required=True)
    parser.add_argument("--psi", action="store_true")
    parser.add_argument("--output", type=Path)
    args = parser.parse_args()
    result = run(args.n, args.psi)
